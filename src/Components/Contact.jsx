        ...
        <div className=''>
            <div className=' w-[90%]  md:w-[85%] py-20 mx-auto'>
                ...
                <div className='flex flex-col lg:flex-row mt-14 gap-10 items-center'>
                    ...
                    <div className='flex-1 bg-[#f7f8fa] dark:bg-slate-950 p-10 rounded-2xl space-y-8'>
                        ...
                        <div className='space-x-6'>
                            <input className='uppercase cursor-pointer px-8 py-4 bg-[#ff2c64] text-white' type="submit" value="Send Message" />
                            <button className='uppercase cursor-pointer px-8 py-4 bg-[#ff2c64] text-white '>Reset</button>
                        </div>
                    </div>
                </div>
            </div>
