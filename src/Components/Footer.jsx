...
const Footer = () => {
    return (
        <footer className=" bg-gray-200 overflow-x-auto  my-20 dark:bg-gray-950 dark:text-gray-100 text-gray-800">
            ...
            <div>
                <footer className="md:footer w-full  dark:text-gray-100 text-gray-800 items-center p-4 md:w-[60%] mx-auto">
